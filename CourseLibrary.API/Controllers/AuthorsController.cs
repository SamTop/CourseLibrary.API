...
namespace CourseLibrary.API.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        {
            if(!_propertyMappingService.ValidMappingExistsFor<Models.AuthorDto, Entities.Author>(authorsResourceParameters.OrderBy))
            {
                return BadRequest();
            }
        ...
        public ActionResult<AuthorDto> CreateAuthor(AuthorForCreationDto author)
        {
            ...
            var resultAuthor = _mapper.Map<AuthorDto>(authorEntity);

            var links = CreateLinksForAuthor(authorEntity.Id, null);
            
            var linkedResourceToReturn =
                _mapper.Map<AuthorDto>(authorEntity).ShapeData(null)
                as IDictionary<string, object>;
